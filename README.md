...
<!-- TODO(author): how to bring data across from Palace; link docs/replace-palace.md -->
...
Enterprise DNA installs Property Management for Claude Code for your business, migrates your Palace data, connects it to the rest of your tools, and runs it for you as part of **Omni**, our managed Command Center. One setup fee, then a monthly retainer.
